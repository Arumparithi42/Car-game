...
def CARGAME():
    ...
    for i in range(n):
        ...
        scar = pg.image.load(asset_path("baby-car.png"))
        win.blit(scar, (100, 0))
    ...
    while run:
        ...
        if not fly:
            ...
            if flyn > 0:
                if flycount >= 0:
                    ...
                    flycarimg = pg.image.load(asset_path("car image-Copy.png"))
        ...
        car = pg.image.load(asset_path("road.png"))
        win.blit(car, (0, 0))
        win.blit(car, (50, 0))
        win.blit(car, (100, 0))
        win.blit(car, (150, 0))
        ...
        carimg = pg.image.load(asset_path("car image.png"))
        ...
        ecarimg1 = pg.image.load(asset_path("enemy car2.png"))
        ...
        if not fly:
            ...
            if score > 80:
                ecarimg = pg.image.load(asset_path("enemy car2.png"))
            ...
            if score > 400:
                ecarimg = pg.image.load(asset_path("enemy car1.png"))
            ...
            if score > 800:
                ecarimg = pg.image.load(asset_path("enemy car3.png"))
